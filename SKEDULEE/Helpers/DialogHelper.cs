...
using SKEDULEE.Views;

namespace SKEDULEE.Helpers
{
    public static class DialogHelper
    {
        ...
        public static bool? ShowMessageBox(string message, string title = "SKEDULEE", string okButtonText = "Ok", string cancelButtonText = "Cancel") =>
